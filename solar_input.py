    ...
    **space_objects** — список объектов планет и звёзд
    ...
    with open(output_filename, 'w') as out_file:
        for obj in space_objects:
            ...
            if obj.type == "star":
                s = "Star " +str(obj.R) +' '+ str(obj.color)+' '+str(obj.m)+' '+str(obj.x)+' '+str(obj.y)+' '+str(obj.Vx)+' '+str(obj.Vy)
                out_file.write(s+'\n')
            if obj.type == "planet":
                s = "Planet "+str(obj.R) +' '+str(obj.color)+' '+str(obj.m)+' '+str(obj.x)+' '+str(obj.y)+' '+str(obj.Vx)+' '+str(obj.Vy)
                out_file.write(s+'\n')
